  ...
  return (
    <>
        ...
        >
          <Flex flexDir="column" gap={3}>
            ...
            <Text fontSize={bodyFontSize}>
              ...
              giving towards a larger vision so that we can accomplish all that
              God has called us and see life transformation through the Gospel.
            </Text>
          </Flex>
        </Container>
      </Flex>
      ...
      <Flex bgColor="#34486F" display={['none', 'block']}>
        <Grid py={5} templateColumns="repeat(7, 1fr)" autoFlow="column dense">
      ...
      <Flex bgColor="#34486F" display={['block', 'none']}>
        <Grid py={3} templateColumns="repeat(5, 1fr)" autoFlow="column dense">
