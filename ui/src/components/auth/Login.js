...
const Login = (props) => {
  ...
  return (
    <>
      ...
      <Stack background='#2C5282' color='white' h='100vh' w='100vw' padding='20px' fontFamily='inter'>
        <Flex>
          <Box>
            <Link href='../sermons'>
        ...
        <Flex justifyContent='center'>
          <VStack justify='center' align='center'>
            <Image 
              ...
              alt='Logo of HMCC' />
            <Text fontWeight='bold' fontSize='2xl'>Log In</Text>
            <form onSubmit={handleSubmit(onSubmit)} autoComplete='off'>
              <VStack align="stretch" marginTop='40px'>
                <input type="email" {...register("email", {required:true})} placeholder="Email" style={inputBoxStyle} />
                <input type="password" {...register("password", {required:true})} placeholder="Password" style={inputBoxStyle} />
                  <Link>
            ...
            <HStack>
              <Flex marginTop='20px' marginBottom='20px'>
                <Image 
                  ...
                  alt='line' />
                <Text marginLeft='15px' marginRight='15px'>I don't have account</Text>
                <Image 
                  w='8vw'
                  src={`${process.env.PUBLIC_URL}/images/VLine.svg`}
                  alt='line' />
