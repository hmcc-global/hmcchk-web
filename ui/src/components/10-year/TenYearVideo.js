...
We invite you to watch, remember, and rejoice in all He has done.`}
      ...
      <Box
        ...
        mx="auto"
        display="grid"
        gridTemplateColumns={{ base: '1fr', md: `minmax(${THUMBS_MIN_W_MD}, 1fr) ${VIDEO_W}` }}
        gridTemplateAreas={{ base: '"video" "pill" "thumbs"', md: '"thumbs video" ". pill"' }}
          ...
          {videos.map((v, idx) => {
            ...
            return (
              <Box
                ...
                boxShadow={isActive 
                  ? { base: '1px 0 10px 0.709px #95CFFF', md: '0 0 25px 4px #95CFFF' }
                  : { base: '0 0 8px rgba(0,0,0,0.3)', md: '0 0 8px rgba(0,0,0,0.3)' }
                }
                _hover={{
                  boxShadow: { base: '0 0 6.951px 0.709px #95CFFF', md: '0 0 18px 1px #95CFFF' },
