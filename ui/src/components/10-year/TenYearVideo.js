...
import { Box, Flex, Heading, Text, VStack, AspectRatio, Image, useBreakpointValue } from '@chakra-ui/react';
import { tenYearTheme } from './theme';

const TenYearVideo = () => {
  const isMobile = useBreakpointValue({ base: true, md: false });
  const isTablet = useBreakpointValue({ base: false, md: false, lg: true, xl: false });
  ...
  const placeholderVideos = ['a', 'b', 'c'].map((id) => ({ id, title: PLACEHOLDER_TITLE, image: PLACEHOLDER_IMAGE }));
  ...
  return (
    <VStack spacing={8} w="100%">
      <VStack spacing={2}>
        ...
        <Text {...tenYearTheme.typography.body} whiteSpace="pre-line" textAlign="center" px={{ base: '2.49rem', lg: 0, xl: 0 }}>
          {isMobile || isTablet
...
We invite you to watch, remember, and rejoice in all He has done.`}
      ...
      <Box
        ...
        mx="auto"
        display="grid"
        gridTemplateColumns={{ base: '1fr', lg: '1fr', xl: `minmax(${THUMBS_MIN_W_MD}, 1fr) ${VIDEO_W}` }}
        gridTemplateAreas={{ base: '"video" "pill" "thumbs"', lg: '"video" "pill" "thumbs"', xl: '"thumbs video" ". pill"' }}
      ...
      >
          ...
          {videos.map((v, idx) => {
            ...
            return (
              <Box
                ...
                boxShadow={isActive 
                  ? { base: '1px 0 10px 0.709px #95CFFF', lg: '1px 0 10px 0.709px #95CFFF', xl: '0 0 25px 4px #95CFFF' }
                  : { base: '0 0 8px rgba(0,0,0,0.3)', lg: '0 0 8px rgba(0,0,0,0.3)', xl: '0 0 8px rgba(0,0,0,0.3)' }
                }
                _hover={{
                  boxShadow: { base: '0 0 6.951px 0.709px #95CFFF', lg: '0 0 6.951px 0.709px #95CFFF', xl: '0 0 18px 1px #95CFFF' },
                ...
                {USE_PLACEHOLDERS ? (
                  ...
                  <>
                    ...
                    <Flex
                      ...
                      bg="rgba(0,0,0,0.3)"
                    >
                      <Image src="/images/10-year/playicon.svg" alt="Play" w={{ base: '1.5rem', lg: '1.75rem', xl: '1.5rem' }} h={{ base: '1.5rem', lg: '1.75rem', xl: '1.5rem' }} />
                    </Flex>
                  </>
                )}
              </Box>
        ...
        <VStack flex={1} spacing={{ base: 0, lg: 0, xl: '1.5rem' }} gridArea="video" w="100%">
          <Box
              ...
              {USE_PLACEHOLDERS ? (
                <>
                  ...
                  <Flex
                    ...
                    justify="center"
                  >
                    <Image src="/images/10-year/playicon.svg" alt="Play" w={{ base: '3.5rem', lg: '4rem', xl: PLAY_ICON_SIZE }} h={{ base: '3.5rem', lg: '4rem', xl: PLAY_ICON_SIZE }} />
                  </Flex>
                </>
              ) : (
        ...
        >
          <Text textAlign="center" {...tenYearTheme.typography.videoTitlePlaceholder}>
