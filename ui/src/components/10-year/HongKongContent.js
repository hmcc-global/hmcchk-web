import { Box, Text, Button, Image, useBreakpointValue, useToast } from '@chakra-ui/react';
      ...
      >
        ...
        <Box mt={4} textAlign="left" alignSelf="stretch">
          <Box
            ...
            alignItems="baseline"
          >
            <Box as="span" fontWeight={700}>Open your mobile banking FPS interface and scan the QR code OR input the FPS identifier</Box>
          </Box>
        </Box>
        <Box mt={4} textAlign="left" alignSelf="stretch">
          <Box
            ...
            alignItems="baseline"
          >
            <Box as="span" fontWeight={700}>FPS ID:</Box> {' '}
            <Box as="span" fontWeight={400}>167534304</Box>
          </Box>
          ...
          <Box
            ...
            alignItems="baseline"
          >
            <Box as="span" fontWeight={700}>Name:</Box> {' '}
            <Box as="span" fontWeight={400}>HARVEST MISSION COMMUNITY CHURCH</Box>
          </Box>
        </Box>
        <Image src={qr_image} alt="FPS QR" mt={4} width={{base: "90px", md: "110px"}} height="auto" />
        <Button
      ...
      >
        ...
        <Box mt={4} textAlign="left" alignSelf="stretch">
          ...
          >
            ...
            <Box as="span" fontWeight={400}>10 Year</Box>
          </Box>
        </Box>
        <Box height="10px"/>
      </Box>
