    ...
    >
      ...
      >
        ...
        <Box display="flex" flexDirection="column" gap={2}>
          <Text
            ...
            textAlign="center"
          >
            Credit card transaction fee (3.5% + HKD $2.35) will be deducted from
            the total amount.
          </Text>
        </Box>
      ...
      >
        ...
        <Text {...tenYearTheme.typography.givingInfo} fontWeight={700}>
          Transfer with Zelle to email address ({email}) and input "10 Year" in
          the giving memo remarks field
        </Text>
        <Button
