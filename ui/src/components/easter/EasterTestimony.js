...
export default function EasterTestimony() {
    ...
    return (
        ...
        >
                        ...
                        >
                            <Box bg="transparent" borderRadius="md" p={{ base: 3, md: 6, lg: 8 }}>
                                <Stack spacing={{ base: 4, md: 5, lg: 6 }}>
                                    ...
                                    >
                                        Include the hashtag{' '}
                                        <Text as="span" fontWeight={700} fontFamily="Manrope" fontSize={{ base: '0.75rem', md: '1rem' }} lineHeight="120.156%">
                                            #hmcc_livinghope
                                        </Text>{' '}
                                        and <br />
                                        tag{' '}
            ...
            <Container maxW="container.xl" px={[4, 6, 8]} mt={{ base: 6, md: 7, lg: 8 }}>
                <Box pt={{ base: 0, md: 8 }}>
                    <Text
                        fontFamily="Instrument Serif"
