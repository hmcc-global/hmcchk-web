        ...
        <Container maxW="100%" py={10}>
          <VStack spacing={[1, 1]} align="stretch">
            ...
            >
              ...
              <Box
                paddingRight={{ sm: '0', md: '10%', lg: '10%' }}
                display="flex"
                bg="none"
                height={{ base: '2.5em', sm: '3em', md: '4em' }}
                justifyContent={{ base: 'center', sm: 'center', md: 'left' }}
              >
                <LinkBox
                  justifyContent={{ base: 'center', sm: 'center', md: 'left' }}
                ...
                >
                  <LinkOverlay target="_blank" onClick={() => setOpen(true)}>
                    <Flex flexDir={'row'}>
                      ...
                      <Text
                        paddingTop={{ base: '2%', sm: '0.5', lg: '1' }}
                        textAlign="right"
                        textStyle="Quicksand_bold"
                        fontSize="inherit"
                        justifyContent={'center'}
                        paddingLeft={{ sm: '2.5', md: '3' }}
                      >
                        Watch Easter Video
                      </Text>
                    </Flex>
            ...
            <Center paddingBottom={'5%'}>
              ...
              >
                <Button
                  ...
                  fontSize={['13px', '1.125em']}
                  target="_blank"
                  height={{ base: '2.7em', sm: '3em', md: '2.5em' }}
                  textStyle="Quicksand_bold"
                  //onClick = {()=> scrollToComponent(InvitationContainer.Insta, { offset: 0, align: 'bottom', duration: 500, ease:'inExpo'})}
                  //onClick={<a href = "#SocialEmbed"></a>}
                  _hover={{
                    background: '#AD8A76',
                    color: '#FFF8F0',
                  }}
