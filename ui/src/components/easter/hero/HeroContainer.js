import { Container, Text, Box, Button, Flex, VStack, Heading, Link, Icon, RiArrowRightLine, RiChat1Line, Faq, Grid, background, LinkOverlay, Image, _hover } from "@chakra-ui/react";
import { SimpleGrid, LinkBox } from "@chakra-ui/react";

//import easterTheme from "../easterTheme";
const HeroContainer = () => {
  return (
    <Box>
      <Box bgImage='white' height = '0'>
      </Box>
      <Box 
      backgroundRepeat='no-repeat'
      bgSize= '100%'
      justifyContent={'bottom'}
      height={{base:'2xl', sm:'fit-content'}}
      marginTop ='10'
      bgColor='white'
      paddingBottom='40%'
      ...
      <Container maxW="container.lg" py={10}>
        <VStack spacing={[1, 1]} align="stretch">
          ...
          <Flex alignContent={'center'} justifyContent={'space-between'} spacing='0px' flexDirection={{base: 'column', sm: 'column', md: 'row'}}>
            ...
            <Box display='flex' bg='none' height={{base: '2.5em', sm: '3em', md: '4em'}}  justifyContent={{base: 'center', sm: 'center', md: 'left'}} >     
                <LinkBox
                    justifyContent={{base: 'center', sm: 'center', md: 'left'}}
                  ...
                  <LinkOverlay href="https://www.youtube.com" target="_blank">
                    <Flex flexDir={'row'}>
                      ...
                      <Text paddingTop = {{base:"1",sm:"-1", lg:"-0.5"}} textAlign = "right" textstyle="quicksand_bold"  fontSize="inherit" justifyContent={'center'} paddingLeft={"3"}>
                        Watch Easter Video
                      </Text>
                    </Flex>
                  </LinkOverlay>
          ...
          <Box
            bgImage={`url('${process.env.PUBLIC_URL}/images/heroeaster/HeroLandingBackground.png')`}
            bgPosition="center"
            bgSize="cover"
            spacing = "0"
            // px={[6, 24, 36]}
          ...
          <Box
            bgImage={`url('${process.env.PUBLIC_URL}/images/heroeaster/HeroLandingMobile.png')`}
            bgPosition="center"
            bgSize="cover"
            spacing = "0"
            height = "60"
