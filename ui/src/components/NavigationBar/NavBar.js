		...
		return(
            ...
            marginLeft="40px"
					...
					<Stack
						...
						alignItems='center'
						isInline>
						<Box fontWeight='600' color='#1A365D' display={{base:'none',md:'flex'}}>
						{loggedIn ? 
							<Menu>
								<MenuButton>
									{welcomeMsg[1]}
						...
						<Box>
							<Button ref={btnRef} onClick={onOpen} style={{background:"none"}}>  
								<Image h='5vh' src='menu.svg' alt='Menu Button' />
							</Button> 
						</Box>
					</Stack>
				</Flex>
            ...
            <Stack
              ...
              <Center>
                <Link href='/live' style={{lineHeight:"0"}}>
                  <Button h='3.5vh' style={liveScStyle} fontSize='xs' lineHeight='0' w='95%' >WATCH SUNDAY CELEBRATION LIVE</Button>
                </Link>
              </Center>
            </Stack>
          </Flex>
