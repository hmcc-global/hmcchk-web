import { Box, Flex, Text, HStack, VStack, Heading, Icon } from '@chakra-ui/react';
import { useState } from 'react';
import ContactForm from '../../pages/building-block/ContactForm';
...
const ContactUs = () => {
  ...
  return (
    <VStack bgColor="#F6FAFF" minW="100%" alignItems="flex-start" my="10">
      ...
      <HStack alignItems="flex-start" w="100%" justifyContent="space-between">
        ...
        >
          ...
          <Icon color="#4A6EEB" my="auto" asChild><LuArrowRight /></Icon>
        </Flex>
      </HStack>
      <Flex
        w="100%"
