...
export function SoapAppDownloadButton() {
  return (
    <VStack minW="50%">
      ...
      <HStack>
        <Link href="https://apps.apple.com/hk/app/daily-soap-bible-reading-app/id1448825436">
          <Image
            h="40px"
            objectFit="cover"
        ...
        <Link href="https://play.google.com/store/apps/details?id=net.hmcc.hongkong.dailysoap">
          <Image
            h="40px"
            objectFit="cover"
